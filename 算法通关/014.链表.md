...
​	上述代码没有使用C++的class封装，读者可以自行实现。

## 链表的反转

​	例题：https://leetcode.cn/problems/reverse-linked-list/

​	给你一个链表的头，返回反转后链表的头。这是一道经典题目，实现方式也可以有多种。下面给出示例代码，很简单，读者自行画图理解。
...
​	https://leetcode.cn/problems/merge-in-between-linked-lists/ （容易++）

​	https://leetcode.cn/problems/remove-nodes-from-linked-list/ （一般++）

### 插入节点

​	https://leetcode.cn/problems/insert-greatest-common-divisors-in-linked-list/ （容易++）

​	https://leetcode.cn/problems/insertion-sort-list/ （一般）

​	https://leetcode.cn/problems/4ueAj6/ （一般+）

​	https://leetcode.cn/problems/insert-into-a-sorted-circular-linked-list/ （同上题，力扣会员题）

### 反转链表

​	https://leetcode.cn/problems/reverse-linked-list-ii/ （一般，反转部分链表）

​	https://leetcode.cn/problems/swap-nodes-in-pairs/ （一般）
