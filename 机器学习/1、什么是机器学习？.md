...
![Supervised learning example 回归](pic\Supervised-learning-example1.png)
...
​	![Supervised learning example 分类](pic\Supervised-learning-example2.png)
...
![Unsupervised learning example1](pic\Unsupervised-learning-example1.png)

​	***example2：***

![Unsupervised learning example2](pic\Unsupervised-learning-example2.png)

​	在该例子中，不同人在相同的基因表达上差不多一致的，会被分为同一组。我们并不知道每组的具体类型是什么，算法制史将基因表达大致相同的人放在一组。

​	***example3：***

![Unsupervised learning example3](pic\Unsupervised-learning-example3.png)
...
![练习题目1](pic\problem1.png)

​		答案：会更坏。训练次数越多，效果越好。

​	**第二题：哪些是监督学习应用的例子？哪些是无监督学习应用的例子？**

![练习题目2](pic\problem2.png)
